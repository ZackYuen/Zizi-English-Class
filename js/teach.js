...
window.ZiziTeach = (function () {
    ...
    function matchHintPayload(word, n) {
        ...
        return {
            ...
            speak: '答案係' + w.yue + '。' + w.story + '揀發光嗰幅圖。'
        };
    }
    ...
    function listenHintPayload(letter, word, n) {
        ...
        if (n === 2) {
            return {
                ...
                speak: '呢個字係' + w.w + '，意思係' + w.yue + '。開頭係' + letter + '。'
            };
        }
        return {
            emoji: w.emoji,
    ...
    function speakStory(word) {
        var w = info(word);
        return speak(w.w + '就係' + w.yue + '。' + w.story);
    }
